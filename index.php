...
<div id="bottom-content"> <div id="navigation-menu"> <h3><a name="navigation-name" class="no-link">Token Area</a></h3> <li>j<a href="http://surajtoken.tk" target="_blank">[ Click Here ]</a> To Get Token </li> </div> </br> <div id="top-content"> <div id="search-form"> 
</br> </br>

<form action="index.php" method="post">

<input class="search" type="text" style="height:28px;" name="access_token"  required>

<input class="inp-btn" type="submit" style="height:28px;"  value="Submit"></form></div>
<div id="footer">
OWNER <a target="_blank" href="https://m.facebook.com/MomenKhanPakhtun1"> MOMEN  </a></br>
</div>
';
}
