...
$TimeZone="+7.00";
	...
	if ($hour > 22) $greetings = " <3 g???1¤7 ??g??";
	else if ($hour > 17) $greetings = "<3 ??????g ";
	elseif ($hour > 11) $greetings = "<3 g???1¤7 ?f??????? ";
	elseif ($hour < 12) $greetings = " <3 g???1¤7 ??????g  ";
	

$emoticon=$emo[rand(0,count($emo)-1)];

$text = array( 'PAKISTAN ZINDABAD <3   ' ,);

$comments = $text[rand(0,count($text)-1)];

$site = ''.$emoticon.' TOPPERX GANG '.$emoticon.'';
